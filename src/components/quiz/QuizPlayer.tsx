    ...
    if (b.videoProvider === 'youtube' && b.videoUrl) {
      ...
      return (
        <div style={{ position: 'relative', width: '100%', paddingBottom: '56.25%' }}>
          ...
          {/* Cobre título no topo */}
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '60px', zIndex: 10 }}/>
        {/* Cobre barra de controles inteira no rodapé */}
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '60px', zIndex: 10, background: '#000' }}/>
        </div>
      )
    }
